                    ...
                    ->schema([
                        Grid::make(2)->schema([
                            Select::make('origin_type')
                                ...
                                ->required()
                                ->default('internal')
                                ->live(), // Rende reattiva la visualizzazione di organization_id
                            ...
                            Select::make('collaboratore')
                                ->label('Tipo soggetto controllato')
                                ->options([
                            ...
                            MorphToSelect::make('auditable')
                                ...
                                ->types([
                                    Type::make(Fornitore::class)
                                        ->titleAttribute('name')
                                        ->modifyOptionsQueryUsing(fn (Builder $query) => $query->whereNotNull('name'))
                                        ->label('Produttore'),
                    ...
                    ->schema([
                        Grid::make(5)->schema([
                            ...
                            Select::make('execution_method')
                                ...
                                ->options([
                                    'audit' => 'Audit Documentale / Da Remoto -OAM-',
                    ...
                    ->schema([
                        Grid::make(2)->schema([
                            ...
                            Select::make('outcome')
                                ...
                                ->live(), // <-- Fondamentale per aggiornare visibilità al volo
