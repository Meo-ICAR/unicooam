...
class ListOamSemestrales extends ListRecords
{
    ...
    */
    ...
    protected function getHeaderActions_old(): array
    {
        $semestre = OamSemester::getInBaseAlMeseCorrente();
        ...
        return [
            ...
            Action::make('export_completo')
                ...
                ->action(function () use (
                    ...
                    $websites,
                    $website_trasparenza,
                    $requisiti_organizzativi,
                    $procedures,
                    $moduli,
                    $externalRoles,
                    $provvigioni_assicurative,
                    $reclami,
                    $sars,
                    $compliance_onsite,
                    $audit_onsite,
                    ...
                    // 2. Dati Economici / Prodotti
                    $datiEconomici = $datiProdotti;
